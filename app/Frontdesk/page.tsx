...
export default function Engineering() {
  return (
    ...
    >
      <div className="group">
        <div className="text-xs absolute sm:top-[4%] sm:left-[23%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
          Guest can make requests via chatbot by <br /> connecting with a hotel
          manager
        </div>
        <div
          className="absolute sm:top-[11%] sm:left-[30%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
        <div className="text-xs absolute sm:top-[4%] sm:left-[60%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
          Celebration packages can be sold via chatbot. Ticket will be <br />{" "}
          automatically created and sent to the guest services team
        </div>
        <div
          className="absolute sm:top-[11%] sm:left-[70%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
      ...
      <div className="group">
        <div className="text-xs absolute sm:top-[43%] sm:left-[18%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
          Weather API connected to the chatbot <br /> for weather inquiries
        </div>
        <div
          className="absolute sm:top-[51%] sm:left-[25%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
        ...
        <div className="text-xs absolute sm:top-[60%] sm:left-[44%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
        ...
        <div
          className="absolute sm:top-[57%] sm:left-[50%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        ...
        <div
          ...
          style={{ transform: "rotate(90deg)" }}
        ></div>
        <div className="text-xs absolute sm:top-[84%] sm:left-[16%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
          chatbot connected to the <br /> property&apos;s website where <br />{" "}
          it can utilize information
        </div>
        <div
          className="absolute sm:top-[81%] sm:left-[20%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
        ...
        <div className="text-xs absolute sm:top-[89%] sm:left-[34%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
          Admin can add local Recommendations
          <br /> for guests via desktop version
        </div>
        <div
          className="absolute sm:top-[86%] sm:left-[40%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
      </div>
      <div className="group">
        ...
        <div className="text-xs absolute sm:top-[37%] sm:left-[55%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
        ...
        <div
          className="absolute sm:top-[46%] sm:left-[65%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(70deg)" }}
        ></div>
        ...
        <div
          className="absolute sm:top-[68%] sm:left-[52%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(30deg)" }}
        ></div>
        <div className="text-xs sm:text-md md:text-xl absolute top-[79%] sm:top-[69%] left-[13%] sm:left-[54%] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          Valet
        </div>
        <div
        ...
        <div className="text-xs absolute sm:top-[85%] sm:left-[70%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
        ...
        <div
          className="absolute sm:top-[82%] sm:left-[80%] border-2 border-dashed border-white w-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
