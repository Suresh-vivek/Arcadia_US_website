...
export default function Engineering() {
  return (
    ...
    >
      ...
      <div className="group">
        <div className="flex flex-col justify-center items-center gap-6 absolute top-[37%] sm:top-[51%] left-[35%] sm:left-[28%] text-xs sm:text-md md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <h1>Weather</h1>
          <div
      ...
      <div className="group">
        <div className="absolute top-[70%] sm:top-[55%] left-[45%] sm:left-[63%] text-xs sm:text-md md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div
            style={{ transform: "rotate(88deg)" }}
            className="h-[2px] sm:h-1 w-8 sm:w-12 md:w-24 bg-white"
          ></div>
        </div>
        <div className="text-xs sm:text-md md:text-xl absolute top-[64%] sm:top-[44%] left-[32%] sm:left-[60%] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          Luggage Assistance
        </div>
        ...
        <div className="text-xs sm:text-md md:text-xl absolute top-[79%] sm:top-[72%] left-[13%] sm:left-[50%] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          Golf Cart Rides
        </div>
        <div
