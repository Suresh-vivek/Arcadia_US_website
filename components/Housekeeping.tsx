...
export default function Housekeeping() {
  return (
    <div id='housekeeping' className='relative w-full h-screen bg-[#e8e8e8] text-[#070708]'>
        <div className='group'>
            <div className='flex flex-col justify-center items-center gap-6 absolute top-[35%] left-[25%] sm:left-[35%] text-xs sm:text-md md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                <h1>Water Bottle</h1>
                <div style={{transform: 'rotate(90deg)'}} className='h-1 w-12 bg-[#070708]'></div>
            </div>
            <div className='absolute top-[35%] left-[35%] sm:left-[50%] text-xs sm:text-md md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                <div style={{transform: 'rotate(125deg)'}} className='h-1 w-48 bg-[#070708]'></div>
            </div>
            ...
            <div className='absolute top-[44%] sm:top-[42%] left-[58%] sm:left-[67%] bg-[#070708] h-1 w-24 opacity-0 group-hover:opacity-100 transition-opacity duration-300' style={{transform: 'rotate(150deg)'}}>
            </div>
            ...
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-lg sm:text-3xl md:text-7xl cursor-pointer'>
                HouseKeeping
            </div>
            <div className='absolute top-[55%] sm:top-[58%] left-[10%] sm:left-[28%] bg-[#070708] h-1 w-24 opacity-0 group-hover:opacity-100 transition-opacity duration-300' style={{transform: 'rotate(150deg)'}}>
            </div>
            <div className='absolute top-[66%] left-[5%] sm:left-[38%] bg-[#070708] h-1 w-48 opacity-0 group-hover:opacity-100 transition-opacity duration-300' style={{transform: 'rotate(130deg)'}}>
            </div>
            <div className='absolute top-[60%] sm:top-[63%] left-[50%] sm:left-[63%] bg-[#070708] h-1 w-24 opacity-0 group-hover:opacity-100 transition-opacity duration-300' style={{transform: 'rotate(90deg)'}}>
            </div>
