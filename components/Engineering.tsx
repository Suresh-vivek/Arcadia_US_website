...
export default function Engineering() {
  return (
    <div
      id="engineering"
      className="relative w-full h-screen bg-white text-[#070708]"
    >
      <div className="group">
        <div className="absolute top-[42%] sm:top-[32%] left-[45%] sm:left-[47%] text-xs sm:text-md md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div
            ...
            className="h-[2px] sm:h-1 w-12 sm:w-24 md:w-36 bg-[#070708]"
          ></div>
        </div>
        ...
        <div
          className="absolute top-[43%] sm:top-[35%] left-[63%] sm:left-[62%] bg-[#070708] h-[2px] sm:h-1 w-12 sm:w-24 md:w-36 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        ...
        <div
          className="absolute top-[50%] sm:top-[50%] left-[16%] sm:left-[25%] bg-[#070708] h-[2px] sm:h-1 w-12 sm:w-24 md:w-36 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(0deg)" }}
        ></div>
        <div
          className="absolute top-[57%] sm:top-[68%] left-[45%] sm:left-[47%] bg-[#070708] h-[2px] sm:h-1 w-12 sm:w-24 md:w-36 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(90deg)" }}
        ></div>
        <div
          className="absolute top-[50%] sm:top-[50%] left-[67%] sm:left-[65%] bg-[#070708] h-[2px] sm:h-1 w-12 sm:w-24 md:w-36 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          style={{ transform: "rotate(0deg)" }}
        ></div>
