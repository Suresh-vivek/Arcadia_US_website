  ...
  return (
    <div className="relative w-full h-[66vh] sm:h-screen">
      ...
      <div className="relative z-10 flex flex-col justify-center sm:justify-around items-center h-full">
        <div className="bg-[#B7A56C] p-2 sm:p-4 m-1 sm:m-2 rounded-lg px-4 sm:px-6 py-6 sm:py-8 text-base sm:text-xl font-semibold transition duration-300 ease-in-out transform hover:scale-105 opacity-75 hover:opacity-100">
          In Room Dining
        </div>
        <div className="bg-[#B7A56C] p-2 sm:p-4 m-1 sm:m-2 rounded-lg px-4 sm:px-6 py-6 sm:py-8 text-base sm:text-xl font-semibold transition duration-300 ease-in-out transform hover:scale-105 opacity-75 hover:opacity-100">
          Amenities
